...
public class SftpUtil {
    ...
    private static final String SFTP_PROTOCAL = "sftp";
    ...
    private static ChannelSftp getSftp(Session session, String host) {
    ...
    private static Session createSession(JSch jsch, String host, String username, int port) throws Exception {
        ...
        session.setProxy(new ProxyHTTP("11.8.44.60", 3128));
    ...
    public static void main(String[] args) throws Exception {
        ChannelSftp sftp = SftpUtil.connect("11.8.44.146", "wasadm", "ect@wasadm", 22);
        download(sftp, "/ztsoft/usr/wasadm/batch/file/20180910", "/Users/lining/billFile", new String[]{});
    }
}
